...
/**
*   The class for the Bishop object which extends ChessPiece
*
...
public class Bishop extends ChessPiece {
    ...
    public Bishop(char type, char color) {
        ...
        if (color== 'W') {
            ...
            icon = new ImageIcon(WHITE_BISHOP_ICON_PATH);
        } else {
            this.setForeground(Color.BLACK);
            icon = new ImageIcon(BLACK_BISHOP_ICON_PATH);
        }
        setIcon(icon);
    }

    /**
     * Gets and returns a copy of the given Bishop
     * 
     * @return a copy of the given Bishop
     */
    @Override
    public Bishop copy() {
        Bishop copiedPiece = new Bishop(this.type, this.color);
        return copiedPiece;
    }

    /**
     * Gets all valid moves that a single Bishop can make
     * 
            ...
            while (true) {
                ...
                if (newRow >= 0 && newRow < 8 && newCol >= 0 && newCol < 8) {
                    ...
                    if (target.getSymbol() == 'E') {
                        String newMove = "B" + startCol + startRow + (char) ('A' + newCol) + (newRow + 1);
